...
- Previous version: 2026.04.01.8
- Trigger: ci/release workflow

- fix: simplify heartbeat suppression — match HEARTBEAT_OK anywhere in response
...
- Previous version: 2026.04.01.4
- Trigger: ci/release workflow

- feat: core inactivity timeout + fix stop command for SDK sessions

## 2026.04.01.4
- Released at: 2026-04-01T14:17:57Z
- Release id: 20260401T141757Z-862eda5
- Previous version: 2026.04.01.3
- Trigger: ci/release workflow

- fix: rewrite production catalog.json to flat tracks schema, add e2e tests
...
- Previous version: 2026.03.31.3
- Trigger: ci/release workflow

- debug: add stderr logging to ClaudeSdkCore.run() to diagnose production hang
...
- Previous version: 2026.03.30.25
- Trigger: ci/release workflow

- remove stale migrations and finance.sqlite from USER_DATA_TOP_LEVEL
...
- Previous version: 2026.03.29.12
- Trigger: ci/release workflow

- fix: remove function sidebar from G2 simulator UI (#204)
...
- Previous version: 2026.03.27.38
- Trigger: ci/release workflow

- refactor: thin finance/index.ts from 1814 to 687 lines
...
- Previous version: 2026.03.27.28
- Trigger: ci/release workflow

- feat: migrate routine/alarm tools to unified function layer
