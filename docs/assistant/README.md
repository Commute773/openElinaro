...
- Core maps: [Repo Layout And Boundaries](repo-layout.md), [Architecture Decisions](architecture-decisions.md), [Configuration And Features](configuration.md), [Runtime Domain Model](runtime-domain-model.md), [Projects](projects.md), [Memory Runtime](memory.md), [Observability](observability.md), [Reflection Runtime](reflection.md), [Tickets Tooling](tickets.md), [Media Runtime](media.md), [Extensions](extensions.md), [G2 API](api.md)
