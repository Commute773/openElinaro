...
// Kept as node:fs because HealthTrackingService methods are called synchronously
// from ToolRegistry, runtime, and test harnesses that would need async conversion.
